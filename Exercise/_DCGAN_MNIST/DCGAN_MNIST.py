...
checkpoint_dir = OUTPUT_PATH+'/training_checkpoints'
...
def display_image(epoch_no):
  return PIL.Image.open(OUTPUT_PATH+'image_at_epoch_{:04d}.png'.format(epoch_no))

display_image(EPOCHS)

with imageio.get_writer(OUTPUT_PATH+'dcgan.gif', mode='I') as writer:
  filenames = glob.glob(OUTPUT_PATH+'image*.png')
...
os.system('cp '+OUTPUT_PATH++'dcgan.gif ' + OUTPUT_PATH+ 'dcgan.gif.png')
display.Image(filename=OUTPUT_PATH++"dcgan.gif.png")
